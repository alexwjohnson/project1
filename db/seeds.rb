...
Release.destroy_all
r1 = Release.create :name => 'DJ Krust: Warhead', :release_type => '12 inch Single', :media => 'vinyl', :image => 'https://res.cloudinary.com/dy9id3syp/image/upload/v1650103782/warheadsteppa_sdjtlk.png'
r2 = Release.create :name => 'Roni Size: Fashion', :release_type => '12 inch Single', :media => 'vinyl', :image => 'https://res.cloudinary.com/dy9id3syp/image/upload/v1650103462/ronisfashion_m2blpe.png'
r3 = Release.create :name => 'Phantom Force', :release_type => '12 inch Single', :media => 'vinyl', :image => 'https://res.cloudinary.com/dy9id3syp/image/upload/v1650103481/phud001_waqs7s.png'
r4 = Release.create :name => 'Capone vs. Peshay', :release_type => '12 inch Single', :media => 'vinyl', :image => 'https://res.cloudinary.com/dy9id3syp/image/upload/v1649908359/cbwwn8s1bcqt6ylxyk3y.jpg'
r5 = Release.create :name => 'Alex Agore : Promised You Love', :release_type => '12 inch Single', :media => 'vinyl', :image => 'https://res.cloudinary.com/dy9id3syp/image/upload/v1649908527/zagas7uwhif9ijimnaz6.png'
r6 = Release.create :name => 'RECK: Eukatech', :release_type => '12 inch Single', :media => 'vinyl', :image => 'https://res.cloudinary.com/dy9id3syp/image/upload/v1650002720/ngsylaq0scg55uh2crsd.jpg'
r7 = Release.create :name => 'Mr. Velcro Fastener: Electrical Applicances', :release_type => '12 inch Single', :media => 'vinyl', :image => 'https://res.cloudinary.com/dy9id3syp/image/upload/v1649908709/bwbmdvxxivszjvza2nvo.png'
r8 = Release.create :name => 'Mr C: Terricola', :release_type => '12 inch Single', :media => 'vinyl', :image => 'https://res.cloudinary.com/dy9id3syp/image/upload/v1649936780/auyp3at43wjaznowgavn.jpg'
r9 = Release.create :name => 'Deee-Lite! Groove Is In The Heart', :release_type => '12 inch EP', :media => 'vinyl', :image => 'https://res.cloudinary.com/dy9id3syp/image/upload/v1649908893/rbt3linec0bf2hfsjti6.png'
r10 = Release.create :name => 'Massive Attack - Ritual', :release_type => '12 inch EP', :media => 'vinyl', :image => 'https://res.cloudinary.com/dy9id3syp/image/upload/v1649909011/an0v773nft4tstm2jffn.jpg'
r11 = Release.create :name => 'King Britt Present Sylk 130 : When The Funk Hits The Fan', :release_type => '12 inch Album', :media => 'vinyl', :image => 'https://res.cloudinary.com/dy9id3syp/image/upload/v1649909048/zfbrbbjs8hhrelfghgms.png'
r12 = Release.create :name => 'Q: Are We Not Men? A: No! We are Devo!', :release_type => '12 inch Album', :media => 'vinyl', :image => 'https://res.cloudinary.com/dy9id3syp/image/upload/v1650003899/c7ropcuzxrychqtz3ukn.jpg'
r13 = Release.create :name => 'Duck Stab', :release_type => '12 inch Album', :media => 'vinyl', :image => 'https://res.cloudinary.com/dy9id3syp/image/upload/v1649939801/rqrgjmuq02pbrz9zrqgr.jpg'
r14 = Release.create :name => 'Look-ka Py-Py', :release_type => '12 inch Album', :media => 'vinyl', :image => 'https://res.cloudinary.com/dy9id3syp/image/upload/v1650102041/duy7a9gp2kgnukypujg0.jpg'
r15 = Release.create :name => 'Duke Ellington & John Coltrane', :release_type => '12 inch Album', :media => 'vinyl', :image => 'https://res.cloudinary.com/dy9id3syp/image/upload/v1650026539/rb4htk8ibg8bcnprbizn.jpg'
r16 = Release.create :name => 'Niney And Friends 1971-1972: Blood And Fire', :release_type => '12 inch Album', :media => 'vinyl', :image => 'https://res.cloudinary.com/dy9id3syp/image/upload/v1649908594/dhajbdfec3skbwwjebiw'
